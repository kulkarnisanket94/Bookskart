        ...
        <MDBRow className="text-center text-md-left mt-3 pb-3">
          <MDBCol md="3" lg="3" xl="4" className="mx-auto mt-3">
            <h6 className="text-uppercase mb-4 font-weight-bold">
              ...
              <strong>BooksKart</strong>
            </h6>
            <p>
              BooksKart is an online React web application where the customer can
          ...
          <MDBCol md="4" lg="3" xl="3" className="mx-auto mt-3">
            ...
            <p>
              <i className="fa fa-envelope mr-3" /> dubeyneeraj@gmail.com
            </p>
            <p>
              <i className="fa fa-phone mr-3" /> +91 9340433274
            </p>
          </MDBCol>
        </MDBRow>
        <hr />
        <MDBRow className="d-flex align-items-center">
          <MDBCol md="8" lg="8">
            <p className="text-center text-md-left grey-text">
              ...
              <a href=""> Neeraj Dubey and Sanket Kulkarni</a>
            </p>
          </MDBCol>
              ...
              <ul className="list-unstyled list-inline">
                <li className="list-inline-item">
                  <a
                    ...
                    href="https://github.com/dubeyneeraj101"
                  >
                ...
                <li className="list-inline-item">
                  <a
                    className="btn-floating btn-sm rgba-white-slight mx-1"
                    href="https://www.linkedin.com/in/neeraj-dubey-7945bb1b1/"
                  >
                ...
                <li className="list-inline-item">
                  <a
                    className="btn-floating btn-sm rgba-white-slight mx-1"
                    href="https://www.instagram.com/__neeraj_23_/"
                  >
